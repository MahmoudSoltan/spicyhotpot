        ...
        <footer className="bg-muted text-muted-foreground bg-orange-50 ">
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className='flex gap-2 items-center'>
                            ...
                            <p>Phone: +(86) 186-0044-3926</p>
                        </div>
                        <div className='flex gap-2'>
                            <Mail className='text-red-500' />
                            <p>Email: info@spicyhotpot.com</p>
                        </div>
                    </div>
                    <div>
                ...
                <div className="mt-8 border-t border-muted-foreground/20 pt-8 text-center">
                    <p>&copy; {new Date().getFullYear()} Your <span className='text-red-500 font-semibold'>Spicy</span> HotPot. All rights reserved Designed By@ Mahmoud Soltan </p>
                </div>
            </div>
        </footer>
    )
