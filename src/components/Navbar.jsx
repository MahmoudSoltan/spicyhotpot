...
function Navbar() {
  ...
  return (
    <header className={`sticky mx-auto top-0 z-30 bg-amber-100 border-2 border-orange-200 transition-all ${header ? 'py-4 bg-orange-100 shadow-lg ' : 'py-6'} `}>
        ...
        <div className='hidden md:flex justify-between items-center px-10 '>
          <div href="/" className="text-primary font-semibold flex gap-1 items-center">
            ...
            <div className='text-red-500 text-xl font-bold'>
              Spicy
              <span className="text-gray-800 font-semibold">HotPot</span>
            </div>
          </div>
